...
var ASM_CONSTS = {
  260216: function() {FS.syncfs(function (err) { if(err) console.log('Cannot sync FS, savegame may not work!'); });},  
 260310: function() {FS.syncfs(function (err) { if(err) console.log('Cannot sync FS, savegame may not work!'); });}
};
