...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5331248,
    DYNAMIC_BASE = 5331248,
    DYNAMICTOP_PTR = 88112;
...
var wasmBinaryFile = 'makedefs.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=88160;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=88208;
  
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 88256, 4), 88256);
